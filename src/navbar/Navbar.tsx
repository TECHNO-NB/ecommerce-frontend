...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      <nav className="border-b-[0.1em] select-none fixed top-0 z-50 bg-[#fff] border-black text-black  h-[4rem] sm:h-[4rem] w-[100vw] flex justify-between items-center    px-2 md:px-16 lg:px-20">
